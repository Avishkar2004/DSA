...
//Notes :- where is front and rear(initailly at the same place) => after added some element in it then rear move along with it
// Circular Queue has fixed amount of space
// noraml queue dont have specific size until we define.
